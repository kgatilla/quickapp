...
public class BankAccountsResourceTest {
    ...
    public void getAccountsForAccountHolder() {
        ...
        assertTrue("Ms. Katia Wolf should not yet have any bank accounts",
                res.contains(RESPONSE_TEXTS.RESPONSE_ERROR_GET_ACCOUNTS_FOR_HOLDER));
        ...
        assertTrue("Ms. Katia Wolf bank account should have been created." + res, !res.contains(RESPONSE_TEXTS.RESPONSE_ERROR_NEW_ACCOUNT_FOR_HOLDER));
    ...
    public void createAccountForAccountHolder() {
        ...
        assertTrue("Ms. Alice Cooper bank account should have been created." + res, !res.contains(RESPONSE_TEXTS.RESPONSE_ERROR_NEW_ACCOUNT_FOR_HOLDER));
    }
    ...
    public void createDuplicateAccountsForAccountHolder() {
        ...
        assertTrue("Mr. James Lund  bank account should have been created." + res, !res.contains(RESPONSE_TEXTS.RESPONSE_ERROR_NEW_ACCOUNT_FOR_HOLDER));

        res = bankAccountsResource
                .createAccountForAccountHolder( id, "GBAABBXX","GB00 1111 0000 1111 2222 00","002233","66020304", "GBP");
        assertTrue("Ms. Alice Cooper duplicate bank account should not be created." + res, res.contains(RESPONSE_TEXTS.RESPONSE_ERROR_NEW_ACCOUNT_FOR_HOLDER));
